...
/**
 * AppTemplateStickyHeader extends the AppLayout web component, and allows users
 * to quickly
 * start developing an application with some preset information given to the
 * AppLayout class.
 * 
 * The template is configured with a sticky header and a some menu items
 * displayed at
 * the top of the application. Classes which extend Div can be displayed in this
 * template,
