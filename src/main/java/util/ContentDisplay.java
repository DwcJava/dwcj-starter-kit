...
/**
 * Helper class which facilitates proper behavior between the tab controls for selection
...
public class ContentDisplay extends Div {
    ...
    /**
     * Removes a page from the content section of the AppLayout class's available for display
     * 
